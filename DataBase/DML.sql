...
INSERT INTO USUARI(usuari_id, nom_usuari, contrasenya, noms, cognoms, nombre_doc_identif, pais_doc_identif, adreca, poblacio, codi_postal, pais_residencia, email, data_alta, rol, idioma_id, actiu, universitat_id)
VALUES (1, 'jdominguez', '1234', 'Joan Antoni', 'Dominguez', '12345678A', 4, 'Carrer 1', 'Ciutat 1', '54321', 4, 'jdominguez@uoc.edu', '01/12/2015', 1, 2, 'true', 1);
INSERT INTO USUARI(usuari_id, nom_usuari, contrasenya, noms, cognoms, nombre_doc_identif, pais_doc_identif, adreca, poblacio, codi_postal, pais_residencia, email, data_alta, rol, idioma_id, actiu, universitat_id)
VALUES (2, 'cceballos', '1111', 'Cristian', 'Ceballos', '23456789B', 4, 'Carrer 2', 'Ciutat 2', '12345', 4, 'cceballos@uoc.edu', '01/12/2015', 2, 1, 'true', 2);
INSERT INTO USUARI(usuari_id, nom_usuari, contrasenya, noms, cognoms, nombre_doc_identif, pais_doc_identif, adreca, poblacio, codi_postal, pais_residencia, email, data_alta, rol, idioma_id, actiu, universitat_id)
VALUES (3, 'imargarit', '4321', 'Ivan', 'Margarit', '34567890C', 4, 'Carrer 3', 'Ciutat 3', '12121', 4, 'imargarit@uoc.edu', '01/12/2015', 3, 1, 'true', 3);
INSERT INTO USUARI(usuari_id, nom_usuari, contrasenya, noms, cognoms, nombre_doc_identif, pais_doc_identif, adreca, poblacio, codi_postal, pais_residencia, email, data_alta, rol, idioma_id, actiu, universitat_id)
VALUES (4, 'mperez', '2222', 'Marc', 'Perez', '45678901D', 4, 'Carrer 4', 'Ciutat 4', '23232', 4, 'mperezcalm@uoc.edu', '01/12/2015', 4, 2, 'true', 4);
...
INSERT INTO ACTIVIDAD(id, universitat_id, centre_id, aula_id, titol, data_inici, data_max_inscripcio, minim_percentatge, numero_plazas) VALUES(1,1,1,1,'Activitat 1', '10/12/2015', '05/12/2015', '60', 50);
INSERT INTO ACTIVIDAD(id, universitat_id, centre_id, aula_id, titol, data_inici, data_max_inscripcio, minim_percentatge, numero_plazas) VALUES(2,2,2,2,'Activitat 2', '15/12/2015', '05/12/2015', '50', 50);
INSERT INTO ACTIVIDAD(id, universitat_id, centre_id, aula_id, titol, data_inici, data_max_inscripcio, minim_percentatge, numero_plazas) VALUES(3,3,3,3,'Activitat 3', '20/12/2015', '15/12/2015', '40', 50);
INSERT INTO ACTIVIDAD(id, universitat_id, centre_id, aula_id, titol, data_inici, data_max_inscripcio, minim_percentatge, numero_plazas) VALUES(4,4,4,4,'Activitat 4', '25/12/2015', '15/12/2015', '70', 50);
...
INSERT INTO MATRICULA(id, usuari_id, activitat_id, data, estat, beca, numero_Compte, grupoid) VALUES(1, 1, 1, '01/12/2015', '2', '0', 1234, 1);
INSERT INTO MATRICULA(id, usuari_id, activitat_id, data, estat, beca, numero_Compte, grupoid) VALUES(2, 2, 2, '01/12/2015', '2', '0', 1212, 1);
INSERT INTO MATRICULA(id, usuari_id, activitat_id, data, estat, beca, numero_Compte, grupoid) VALUES(3, 3, 3, '01/12/2015', '2', '0', 3434, 1);
INSERT INTO MATRICULA(id, usuari_id, activitat_id, data, estat, beca, numero_Compte, grupoid) VALUES(4, 4, 4, '01/12/2015', '2', '0', 4321, 1);
...
INSERT INTO GRUPO(grupoid, nombre, maxalumnos, plazasdisponibles, fechainicio, fechafin, grupovigente, turno, idactividad) VALUES(1, 'Grupo 1', 50, 50, '01/12/2015', '01/06/2016', '1', 1, 1);
INSERT INTO GRUPO(grupoid, nombre, maxalumnos, plazasdisponibles, fechainicio, fechafin, grupovigente, turno, idactividad) VALUES(2, 'Grupo 2', 50, 50, '01/12/2015', '01/06/2016', '1', 1, 1);
INSERT INTO GRUPO(grupoid, nombre, maxalumnos, plazasdisponibles, fechainicio, fechafin, grupovigente, turno, idactividad) VALUES(3, 'Grupo 3', 50, 50, '01/12/2015', '01/06/2016', '1', 1, 1);
INSERT INTO GRUPO(grupoid, nombre, maxalumnos, plazasdisponibles, fechainicio, fechafin, grupovigente, turno, idactividad) VALUES(4, 'Grupo 4', 50, 50, '01/12/2015', '01/06/2016', '1', 1, 1);