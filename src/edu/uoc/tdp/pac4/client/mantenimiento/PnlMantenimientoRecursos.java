 ...
 *********************************************************************/
public class PnlMantenimientoRecursos extends javax.swing.JDialog 
{
...
public PnlMantenimientoRecursos(java.awt.Frame parent, boolean modal, Mantenimiento manager, LanguageUtils language) {
        super(parent, modal); 
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(comboAula, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(27, 27, 27)
...
//Establece los textos segun idioma seleccionado      
   private void prepararTextos() {
        this.setTitle(language.getProperty("mantenimiento.recursos.Mantenimiento"));
        ...
        this.lblCentro.setText (language.getProperty("mantenimiento.Aula"));
...
//Se escoge 'Alta de Recurso'  
   private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
           PnlMantenimientoRecursoGestor form = new PnlMantenimientoRecursoGestor(null, true ,manager, language, "Add", 0);
           form.setLocationRelativeTo(null);
           form.setVisible(true);
           listarRecursos();
   }//GEN-LAST:event_btnAddActionPerformed

//Se escoge 'Edición de Recurso'     
   private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
      //No hay  fila seleccionada
      if (tblData.getSelectedRow() < 0)
      {
         JOptionPane.showMessageDialog(null,
                                       language.getProperty("mantenimiento.msg.NoRecurso"),
      ...
      Recurso rec = recursos.get(tblData.getSelectedRow());
      PnlMantenimientoRecursoGestor form = new PnlMantenimientoRecursoGestor(null, true, manager, language, "Edit", rec.getIdRecurso());
      form.setLocationRelativeTo(null);
      form.setVisible(true);
      listarRecursos();
...
//Se escoge Desactivar Recurso
   private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
      ...
      int reply = JOptionPane.showOptionDialog(this, language.getProperty("mantenimiento.msg.EliminarRecurso"),
                                               language.getProperty("app.title"), JOptionPane.YES_NO_OPTION, 
                                               JOptionPane.QUESTION_MESSAGE, null, options, rec);
      if (reply == 0) {
      try {
            manager.eliminarRecurso(rec.getIdRecurso());
...
//Botón Limpiar Filtro
    private void btnClearFilterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClearFilterActionPerformed
        ...
        this.comboAula.setSelectedIndex(0);
        this.dofilter = false;
        listarRecursos();
...
//Consultar Recurso
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
      ...
      PnlMantenimientoRecursoGestor form = new PnlMantenimientoRecursoGestor(null, true, manager, language, "Explore", rec.getIdRecurso());
      form.setLocationRelativeTo(null);
      form.setVisible(true);
...
//Cargar todos los Recursos
    private void todasAulas() throws SQLException, RemoteException, Exception {
        ...
        header.add(language.getProperty("mantenimiento.recursos.Codigo"));
        header.add(language.getProperty("mantenimiento.recursos.Nombre"));
        header.add(language.getProperty("mantenimiento.recursos.Descripcion"));

        
        String[][] gridData;
        
        recursos = manager.getRecursos();
        
        gridData = new String[recursos.size()][3];
        
        int i = 0;
        for (Recurso recurso: recursos) {
            gridData[i][0] = recurso.getCodigoRecurso();
            gridData[i][1] = recurso.getNombreRecurso();
            gridData[i][2] = recurso.getDescripcionRecurso();
            i++;
        }
...
//Cargar Recursos Filtrados
    private void filtrarRecursos() throws SQLException, RemoteException, Exception {
        ArrayList<String> header = new ArrayList<String>();   // cabecera
        ...
        recursos = manager.getRecursos();
            ...
            recursos=manager.getRecursosInactivos();
        }
        gridData = new String[recursos.size()][3];
        int i = 0;
        for (Recurso recurso : recursos) {
            if ( recurso.getNombreRecurso().contains(this.fldNombre.getText())) {
                if(comboAula.getSelectedIndex()==0){
            gridData[i][0] = recurso.getCodigoRecurso();
            gridData[i][1] = recurso.getNombreRecurso();
            gridData[i][2] = recurso.getDescripcionRecurso();
            i++;
                } else{
                    if(recurso.getAulaRecurso()==((ComboItem)comboAula.getSelectedItem()).getId()){
                            gridData[i][0] = recurso.getCodigoRecurso();
                            gridData[i][1] = recurso.getNombreRecurso();
                            gridData[i][2] = recurso.getDescripcionRecurso();
                             i++;
