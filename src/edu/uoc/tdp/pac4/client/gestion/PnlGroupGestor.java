...
public class PnlGroupGestor extends javax.swing.JDialog 
{
    ...
    private void initComponents() {
        ...
        pnlFilterLayout.setHorizontalGroup(
            ...
            .addGroup(pnlFilterLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(pnlFilterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cboActividad, javax.swing.GroupLayout.PREFERRED_SIZE, 239, javax.swing.GroupLayout.PREFERRED_SIZE)
   ...
   private void cmdSetFilterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdSetFilterActionPerformed
      ...
      int idActividad = (cboActividad.getSelectedIndex() >= 0 ? ((Actividad)cboActividad.getSelectedItem()).getId() : -1);
      ...
      fillForm(idActividad, idTurno, fechaIni, fechaFin);
   ...
   private void fillFilterPanel() 
   {
      try 
      {
         ...
         cboActividad.setModel(new DefaultComboBoxModel(manager.getActividades().toArray()));
   ...
   private void setLanguage()
   {
      ...
      lblActividad.setText(language.getProperty(eAcademiaEU.FORM_PNLGROUPGESTOR_ACTIVIDAD));
    ...
    */
   private void fillForm(int idActividad, int idTurno, Date fechaInicio, Date fechaFin)
   {
      ...
      header.add(language.getProperty(eAcademiaEU.FORM_PNLGROUPGESTOR_ACTIVIDAD));
      ...
      try 
      {
         ...
         grupos = manager.getGrupos(idActividad, idTurno, fechaInicio, fechaFin);
         ...
         for (Grupo grupo : grupos)
         {
            ...
            gridData[i][4] = (grupo.getFechaInicioActividad() == null ? "?" : df.format(grupo.getFechaInicioActividad()));
