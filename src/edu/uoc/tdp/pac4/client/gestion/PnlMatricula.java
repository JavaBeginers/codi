...
public class PnlMatricula extends javax.swing.JDialog 
{
   ...
   private void cboGrupoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboGrupoActionPerformed
      ...
      try 
      {
         ...
         lblFechas.setText(grupo.getFechaInicioCurso().toString() + " - " + grupo.getFechaFinCurso().toString());
         ...
         curso = manager.getCurso(grupo.getIdCurso());
      ...
      try 
      {
         numPlazasMañana = manager.getPlazasDisponibles(curso.getId(), Grupo.TURNO_MANANA);
      ...
      try 
      {
         numPlazasTarde = manager.getPlazasDisponibles(curso.getId(), Grupo.TURNO_TARDE);
   ...
   private void setLanguage()
   {
      ...
      lblLabelCurso.setText(language.getProperty(eAcademiaEU.FORM_PNLMATRICULA_CURSO));
      ...
      lblCurso.setText(language.getProperty(eAcademiaEU.FORM_PNLMATRICULA_SELECTGRUPO));
   ...
   private void fillLists()
   {
      ...
      try 
      {
         // Informa del curso al que pertenece la matrícula
         int idCurso = this.matricula.getCursoId();
         grupos = manager.getGrupos(idCurso);
         cboGrupo.removeAll();
