...
/**
 * Implementa el gestor de literales de texto usado por el GUI de la aplicación.
 * 
...
public class LanguageUtils 
{
   ...
   public void setActiveLanguage(String key) {
       if (key.equals(this.LANG_SPANISH)) {
           this.activeLanguage = 0;
       }
       else if (key.equals(this.LANG_CATALAN)) {
           this.activeLanguage = 1;
       }
       else if (key.equals(this.LANG_ENGLISH)) {
   ...
   public String getActiveLanguage() {
       ...
       if (this.activeLanguage == 0) {
           lang = this.LANG_SPANISH;
       }
       else if (this.activeLanguage == 1) {
           lang = this.LANG_CATALAN;
       }
       else if (this.activeLanguage == 2)
       {
           lang = this.LANG_ENGLISH;
       }
       return lang;
   }
