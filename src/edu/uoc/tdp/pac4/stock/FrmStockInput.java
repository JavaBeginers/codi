...
/**
 * Implementa el formulario de introducción de estoc.
 * 
 * @author eSupport Netbeans
 */
public class FrmStockInput extends javax.swing.JDialog 
{
   private GestorEstoc rmiManager;
   private LanguageUtils language = new LanguageUtils();
   
   /**
    * Creates new form FrmStockInput
    */
   public FrmStockInput(PnlMain parent, boolean modal, GestorEstoc manager, LanguageUtils language) 
   {
      super(parent, modal);
      ...
      // Rellena los campos con sus valores adecuados
      txtNumItems.setText("1");
      
      // Establece los literales de idioma
      this.setTitle(language.getProperty("form.addStock.title"));
      lblResource.setText(language.getProperty("form.addStock.lblResource"));
      lblNumItems.setText(language.getProperty("form.addStock.lblNumItems"));
      cmdAccept.setText(language.getProperty("form.common.accept"));
      cmdCancel.setText(language.getProperty("form.common.cancel"));
      
      // Rellena la lista de recursos
      try 
      {
   ...
   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        lblResource.setText("Tipo de recurso");

        txtNumItems.setText("1");

        lblNumItems.setText("Cantidad");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cboResourceType, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtNumItems, javax.swing.GroupLayout.PREFERRED_SIZE, 59, javax.swing.GroupLayout.PREFERRED_SIZE))
   ...
   private void cmdAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAcceptActionPerformed
      ...
      {
         JOptionPane.showMessageDialog(null, 
                                       language.getProperty("form.addStock.incorrectNumItems"), 
                                       language.getProperty("app.title"), 
      ...
      {
         JOptionPane.showMessageDialog(null, 
                                       language.getProperty("form.addStock.noSelectedResource") ,
                                       language.getProperty("app.title"), 
                                       JOptionPane.WARNING_MESSAGE);
         return;
      }
      ...
      {
         // Añade el stock
         rmiManager.setEntradaStock(((Recurso)cboResourceType.getSelectedItem()).getIdRecurso(), 
